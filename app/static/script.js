...
//             // Update Pixtral evaluation
//             const evalDiv = document.querySelector('.evaluation');
//             if (data.pixtral_score !== null) {
//                 evalDiv.innerHTML = `<p><strong>Pixtral Evaluation:</strong></p><p>Score: ${data.pixtral_score}/5</p><p>${data.pixtral_explanation}</p>`;
//             } else {
//                 evalDiv.innerHTML = `<p><strong>Pixtral Evaluation:</strong></p><p>Score: Not available</p><p>${data.pixtral_explanation}</p>`;
//             }
//         }
//     })
//     .catch(error => {
